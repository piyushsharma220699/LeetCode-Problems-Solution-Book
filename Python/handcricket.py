...
print("""Welcome to the HAND CRICKET GAME!
        ...
        2)If you win, you can choose either BATTING or BOWLING
            if you choose BATTING:
                ...
                4) you will be OUT if you and the computer enter the same number, you will be OUT and the computer will 
                be bowling and the computer will chase the target set by you.
            5) if the  computer can chase the target, the computer WINS. If not, You WIN
            if you choose BOWLING:
                1) the computer will be batting so your objective will be to oust the computer by guessing a number 
                that the computer might guess.
                2) once the computer is out, you bat and the above rules apply.
        3) you have only one wicket so play carefully
...
# toss_randomizer = randomises toss using a random number between 1(heads) and 2(tails). using an if statement, this is
# then assigned accordingly to "toss".
# toss_input = asks user for a toss choice: 1 for heads and 2 for tails accordingly assigns it to "toss_user"
# toss_user  = basically, takes an input from the "toss_input" variable from the user and gets assigned to heads or
# tails.
# user_choice = upon winning the toss, this variable stores your play choice i.e. 1 for batting and 2 for bowling.
# comp_int = takes a random integer between 1 and 2 and assigns it to batting or bowling accordingly and stores it in
# the "comp_choice" variable.
# comp_choice = takes input from "comp_int" and gets assigned as the computers choice of play i.e batting or bowling
# when the player loses the toss.
...
# comp_out = boolean value deciding whether computer is out or not
# toss_status = status of toss whether player won the toss or the computer won
